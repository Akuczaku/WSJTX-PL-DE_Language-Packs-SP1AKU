...
- `docs/` – Polish and German HTML User Guides
...
For end users, download the ready-to-use ZIP archives from **GitHub Releases**.

## Translation validation

Polish: 1824 messages, 0 unfinished, 0 empty, 0 Qt placeholder errors.  
German: 1804 messages, 0 unfinished, 0 empty, 0 Qt placeholder errors.

## Attribution

Language translations and packaging: **SP1AKU Czaku**.  
Original WSJT-X: WSJT Development Team and respective contributors.

See `COPYING` and `LICENSE-NOTICE.md`.
